...
def main():
    ...
    summary = {
        ...
        "config": {
            ...
            "TTN_LATENT_DIM": int(config.TTN_LATENT_DIM),
            "TTN_BOND_DIM": int(config.TTN_BOND_DIM),
            "TTN_ROOT_DIM": int(config.TTN_ROOT_DIM),
            "TTN_USE_BOND_CAP": bool(config.TTN_USE_BOND_CAP),
            "TTN_TREE_PAIRING": str(config.TTN_TREE_PAIRING),
