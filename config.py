...
EPOCHS = _env_int(
    "QSP_EPOCHS",
    _default_by_qubits({4: 5000, 6: 3000}, 120),
)
...
EARLY_STOPPING_PATIENCE = _env_int("QSP_EARLY_STOPPING_PATIENCE", 1200)
EARLY_STOPPING_MIN_EPOCHS = _env_int("QSP_EARLY_STOPPING_MIN_EPOCHS", min(int(EPOCHS), 1200))
