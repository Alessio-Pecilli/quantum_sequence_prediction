...
EMBEDDING_DIM = _env_int("QSP_EMBEDDING_DIM", 16)
AUTOENCODER_HIDDEN_DIM = _env_int("QSP_AUTOENCODER_HIDDEN_DIM", 1024)
NUM_HEADS = _env_int("QSP_NUM_HEADS", 8)
NUM_LAYERS = _env_int("QSP_NUM_LAYERS", 8)
...
BATCH_SIZE = _env_int("QSP_BATCH_SIZE", 256)
AUTOENCODER_BATCH_SIZE = _env_int("QSP_AUTOENCODER_BATCH_SIZE", 128)
EPOCHS = _env_int(
    "QSP_EPOCHS",
    _default_by_qubits({4: 10000, 6: 100}, 120),
)
AUTOENCODER_EPOCHS = _env_int("QSP_AUTOENCODER_EPOCHS", 1500)
LEARNING_RATE = _env_float("QSP_LEARNING_RATE", 5e-4)
AUTOENCODER_LEARNING_RATE = _env_float("QSP_AUTOENCODER_LEARNING_RATE", 3e-4)
